...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\my_package_python\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\my_package_python\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\my_package_python\hook\ament_prefix_path.bat"
