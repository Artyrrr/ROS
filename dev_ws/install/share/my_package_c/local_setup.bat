...
set "AMENT_ENVIRONMENT_HOOKS[my_package_c]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_package_c] "%AMENT_CURRENT_PREFIX%\share\my_package_c\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_package_c] "%AMENT_CURRENT_PREFIX%\share\my_package_c\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[my_package_c]:;=";"%") do (
    call:call_file %%f
  )
