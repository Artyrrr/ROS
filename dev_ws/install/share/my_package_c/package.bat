...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\my_package_c\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\my_package_c\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/my_package_c/local_setup.bat"
