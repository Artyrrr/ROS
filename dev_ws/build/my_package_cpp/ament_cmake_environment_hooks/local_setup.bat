...
set "AMENT_ENVIRONMENT_HOOKS[my_package_cpp]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_package_cpp] "%AMENT_CURRENT_PREFIX%\share\my_package_cpp\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_package_cpp] "%AMENT_CURRENT_PREFIX%\share\my_package_cpp\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[my_package_cpp]:;=";"%") do (
    call:call_file %%f
  )
