...
set "AMENT_ENVIRONMENT_HOOKS[dictionary_interface]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dictionary_interface] "%AMENT_CURRENT_PREFIX%\share\dictionary_interface\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dictionary_interface] "%AMENT_CURRENT_PREFIX%\share\dictionary_interface\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dictionary_interface] "%AMENT_CURRENT_PREFIX%\share\dictionary_interface\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[dictionary_interface]:;=";"%") do (
    call:call_file %%f
  )
